...
import { MapPin, Plus, Check, CreditCard, Truck, ArrowLeft, Loader2, QrCode, Wallet } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1 w-full space-y-8">
        ...
        {showAddModal && (
          <div className="fixed inset-0 z-50 bg-ink/60 backdrop-blur-xs flex items-center justify-center p-4">
            <div className="bg-warm-white border border-chalk p-6 max-w-md w-full shadow-lg space-y-4 font-sans">
              <h3 className="font-serif text-lg text-ink">Thêm địa chỉ giao hàng mới</h3>
              <form onSubmit={handleAddAddress} className="space-y-3 font-mono text-xs">
                <input
                  type="text"
                  ...
                  className="w-full p-3 bg-canvas border border-chalk text-ink focus:outline-none focus:border-stitch"
                />
                <input
                  type="text"
                ...
                <div className="grid grid-cols-3 gap-2">
                  <input
                    ...
                    className="w-full p-2 bg-canvas border border-chalk text-ink focus:outline-none focus:border-stitch"
                  />
                  <input
                    type="text"
                ...
                <div className="flex justify-end gap-2 pt-2">
                  <button
                    ...
                    className="px-4 py-2 border border-chalk text-smoke hover:text-ink transition-colors"
                  >
                    Hủy
                  </button>
                  <button
                    type="submit"
                    className="px-5 py-2 bg-ink hover:bg-stitch text-warm-white uppercase tracking-wider transition-colors"
                  >
                    Lưu địa chỉ
                  </button>
                </div>
