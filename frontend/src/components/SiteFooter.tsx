        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 pb-12 border-b border-line">
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-ink-soft">
              <li><Link to="/products?category=ao-so-mi" className="hover:text-accent transition">Áo Sơ Mi Nam</Link></li>
              <li><Link to="/products?category=ao-polo" className="hover:text-accent transition">Áo Polo Nam</Link></li>
              <li><Link to="/products?category=quan-tay" className="hover:text-accent transition">Quần Tây & Kaki</Link></li>
              <li><Link to="/products?category=ao-khoac" className="hover:text-accent transition">Áo Khoác Nam</Link></li>
              <li><Link to="/products" className="hover:text-accent transition">Tất cả sản phẩm</Link></li>
            </ul>
          </div>
