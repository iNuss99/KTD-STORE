  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome',
      sender: 'ai',
      text: 'Xin chào anh! Em là Trợ lý AI Stylist của KTDL — Studio chuyên các dòng Áo Nam cao cấp. Anh đang tìm form dáng áo (Sơ mi, Polo, T-Shirt, Blazer) hay cần tư vấn size áo ạ?',
    },
  ]);
